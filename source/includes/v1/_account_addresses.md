...
```shell
 GET https://subdomain.mybrightsites.com/api/v1/users/494/addresses?token=GXzAxWkkyYLsESGQTU15 
```
...
```shell
 GET https://subdomain.mybrightsites.com/api/v1/users/494/addresses/1006?token=GXzAxWkkyYLsESGQTU15 
```
...
`PATCH /api/v1/users/:user_id/addresses/:id`
...
```shell
 DELETE https://subdomain.mybrightsites.com/api/v1/users/494/addresses/1556?token=GXzAxWkkyYLsESGQTU15 
```
