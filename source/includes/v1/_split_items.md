...
```shell
curl "https://subdomain.mybrightsites.com/api/v1/orders/2089/line_items/25135/split_items?token=GXzAxWkkyYLsESGQTU15"
```
...
```shell
curl "https://subdomain.mybrightsites.com/api/v1/orders/2089/line_items/25135/split_items/108?token=GXzAxWkkyYLsESGQTU15"
```
