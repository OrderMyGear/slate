...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.6/products/22287/options?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v1.1.6/products/:product_id/options`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.6/products/22287/options/47204?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v1.1.6/products/:product_id/options/:id`
...
`POST /api/v1.1.6/products/:product_id/options`
...
`PUT|PATCH /api/v1.1.6/products/:product_id/options/:id`
...
`DELETE /api/v1.1.6/products/:product_id/options/:id`
