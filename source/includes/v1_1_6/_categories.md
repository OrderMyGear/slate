...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.6/categories/579?token=GXzAxWkkyYLsESGQTU15"
```
...
`PUT|PATCH /api/v1.1.6/categories/:id`
...
`DELETE /api/v1.1.6/categories/:id`
