...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.7.0/products?token=GXzAxWkkyYLsESGQTU15"
```
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.7.0/products/579?token=GXzAxWkkyYLsESGQTU15"
```
...
`PUT|PATCH /api/v2.7.0/products/:id`
