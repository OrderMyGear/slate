...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.7.0/orders?token=GXzAxWkkyYLsESGQTU15"
```
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.7.0/orders/1?token=GXzAxWkkyYLsESGQTU15"
```
...
`PUT|PATCH /api/v2.7.0/orders/:id`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.7.0/orders/1/cancel?token=GXzAxWkkyYLsESGQTU15" \
  -X PUT
```
...
`PUT|PATCH /api/v2.7.0/orders/:id/cancel`
