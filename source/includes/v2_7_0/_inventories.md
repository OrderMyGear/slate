...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.7.0/inventories?token=GXzAxWkkyYLsESGQTU15"
```
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.7.0/inventories/44371/batch_update?token=GXzAxWkkyYLsESGQTU15" \
  -X PUT \
...
`PUT|PATCH /api/v2.7.0/inventories/:product_id/batch_update`
