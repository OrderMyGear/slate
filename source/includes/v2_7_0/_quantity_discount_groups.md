...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.7.0/products/1/quantity_discount_groups?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v2.7.0/products/:product_id/quantity_discount_groups`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.7.0/products/1/quantity_discount_groups/579?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v2.7.0/products/:product_id/quantity_discount_groups/:id`
...
`POST /api/v2.7.0/products/:product_id/quantity_discount_groups`
...
`PUT|PATCH /api/v2.7.0/products/:product_id/quantity_discount_groups/:id`
...
`DELETE /api/v2.7.0/products/:product_id/quantity_discount_groups/:id`
