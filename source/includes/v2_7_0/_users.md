...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.7.0/users?token=GXzAxWkkyYLsESGQTU15"
```
...
<div><strong>email </strong></div><div>optional</div> | <div>Filter by email address</div><div>Must be a String</div>
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.7.0/users/579?token=GXzAxWkkyYLsESGQTU15"
```
