...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.0.0/products/1/quantity_discount_groups/579?token=GXzAxWkkyYLsESGQTU15"
```
...
`PUT|PATCH /api/v2.0.0/products/:product_id/quantity_discount_groups/:id`
