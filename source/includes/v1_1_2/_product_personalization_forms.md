...
`GET /api/v1.1.2/products/:product_id/personalization_forms`
...
`GET /api/v1.1.2/products/:product_id/personalization_forms/:id`
...
`POST /api/v1.1.2/products/:product_id/personalization_forms`
...
`PUT|PATCH /api/v1.1.2/products/:product_id/personalization_forms/:id`
...
`DELETE /api/v1.1.2/products/:product_id/personalization_forms/:id`
