...
Keep in mind, the response will return up to 500 records on a single page and you will need to use "per_page" and "page" URL parameters to see all the records.Keep in mind, the response will return up to 500 records on a single page and you will need to use "per_page" and "page" URL parameters to see all the records.
...
`GET /api/api/v1.1.2/products/:product_id/related_products`
...
`POST /api/api/v1.1.2/product/:product_id/related_products/:id`
...
`DELETE /api/api/v1.1.2/product/:product_id/related_products/:id`
