...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.2/products/22287/decoration_methods?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v1.1.2/products/:product_id/decoration_methods`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.2/products/22287/decoration_methods/1?token=GXzAxWkkyYLsESGQTU15" \
  -X PUT \
...
`PUT /api/v1.1.2/products/:product_id/decoration_methods/:id`
