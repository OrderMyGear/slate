...
`GET /api/v1.1.5/products/:product_id/personalization_forms`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.5/products/1/personalzation_forms/580?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v1.1.5/products/:product_id/personalization_forms/:id`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.5/products/1/personalization_forms?token=GXzAxWkkyYLsESGQTU15" \
  -X POST \
...
`POST /api/v1.1.5/products/:product_id/personalization_forms`
...
`PUT|PATCH /api/v1.1.5/products/:product_id/personalization_forms/:id`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.5/products/1/personalization_forms/580?token=GXzAxWkkyYLsESGQTU15" \
  -X DELETE
```
...
`DELETE /api/v1.1.5/products/:product_id/personalization_forms/:id`
