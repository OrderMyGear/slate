...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.5/users/494/addresses?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v1.1.5/users/:user_id/addresses`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.5/users/494/addresses/1006?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v1.1.5/users/:user_id/addresses/:id`
...
`POST /api/v1.1.5/users/:user_id/addresses`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.5/users/494/addresses/1556?token=GXzAxWkkyYLsESGQTU15" \
  -X PUT \
  -H "Content-Type: application/json" \
  -d @- <<'EOF'
{
...
`PUT|PATCH /api/v1.1.5/users/:user_id/addresses/:id`
...
`DELETE /api/v1.1.5/users/:user_id/addresses/:id`
