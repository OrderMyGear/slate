...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.5/products?token=GXzAxWkkyYLsESGQTU15"
```
...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.5/products/579?token=GXzAxWkkyYLsESGQTU15"
```
...
`PUT|PATCH /api/v1.1.5/products/:id`
