...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.3.0/products/22287/logo_locations?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v2.3.0/products/:product_id/logo_locations`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.3.0/products/22287/logo_locations/1?token=GXzAxWkkyYLsESGQTU15" \
  -X PUT \
...
`PUT|PATCH /api/v2.3.0/products/:product_id/logo_locations/:id`
