...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.3.0/products/22287/decoration_methods?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v2.3.0/products/:product_id/decoration_methods`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.3.0/products/22287/decoration_methods/1?token=GXzAxWkkyYLsESGQTU15" \
  -X PUT \
...
`PUT /api/v2.3.0/products/:product_id/decoration_methods/:id`
