...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.3.0/products/22287/inventories?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v2.3.0/products/:product_id/inventories`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.3.0/products/22287/inventories/774?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v2.3.0/products/:product_id/inventories/:id`
...
`POST /api/v2.3.0/products/:product_id/inventories`
...
`PUT|PATCH /api/v2.3.0/products/:product_id/inventories/:id`
...
`DELETE /api/v2.3.0/products/:product_id/inventories/:id`
