...
`GET /api/v2.3.0/products/:product_id/quantity_discount_groups`
...
`GET /api/v2.3.0/products/:product_id/quantity_discount_groups/:id`
...
`POST /api/v2.3.0/products/:product_id/quantity_discount_groups`
...
`PUT|PATCH /api/v2.3.0/products/:product_id/quantity_discount_groups/:id`
...
`DELETE /api/v2.3.0/products/:product_id/quantity_discount_groups/:id`
