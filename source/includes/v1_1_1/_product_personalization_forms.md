...
`GET /api/v1.1.1/products/:product_id/personalization_forms`
...
`GET /api/v1.1.1/products/:product_id/personalization_forms/:id`
...
`POST /api/v1.1.1/products/:product_id/personalization_forms`
...
`PATCH /api/v1.1.1/products/:product_id/personalization_forms/:id`
...
`PUT /api/v1.1.1/products/:product_id/personalization_forms/:id`
...
`DELETE /api/v1.1.1/products/:product_id/personalization_forms/:id`
