...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.1/products/1/quantity_discounts/579?token=GXzAxWkkyYLsESGQTU15"
```
...
`PATCH /api/v1.1.1/products/:product_id/quantity_discount_groups/:id`
