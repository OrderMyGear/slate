...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.1/vendors?token=GXzAxWkkyYLsESGQTU15"
```
...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.1/vendors/579?token=GXzAxWkkyYLsESGQTU15"
```
...
`PUT|PATCH /api/v1.1.1/vendors/:id`
