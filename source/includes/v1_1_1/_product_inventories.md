...
`GET /api/v1.1.1/products/:product_id/inventories`
...
`GET /api/v1.1.1/products/:product_id/inventories/:id`
...
`POST /api/v1.1.1/products/:product_id/inventories`
...
`PATCH /api/v1.1.1/products/:product_id/inventories/:id`
...
`PUT /api/v1.1.1/products/:product_id/inventories/:id`
...
`DELETE /api/v1.1.1/products/:product_id/inventories/:id`
