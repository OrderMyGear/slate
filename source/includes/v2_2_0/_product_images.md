...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.2.0/products/1/images?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/api/v2.2.0/products/:product_id/images`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.2.0/products/579/product_images/1?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v2.2.0/products/:product_id/images/:id`
...
`POST /api/api/v2.2.0/product/:product_id/images`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.2.0/products/1/images/2?token=GXzAxWkkyYLsESGQTU15" \
  -X PUT \
  -H "Content-Type: application/json" \
  -d @- <<'EOF'
{
...
`PUT|PATCH /api/api/v2.2.0/product/:product_id/images/:id`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.2.0/products/1/images/579?token=GXzAxWkkyYLsESGQTU15" \
  -X DELETE
```
...
`DELETE /api/v2.2.0/products/:product_id/images/:id`
