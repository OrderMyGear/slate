...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.4/products/22287/inventories?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v1.1.4/products/:product_id/inventories`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.4/products/22287/inventories/774?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v1.1.4/products/:product_id/inventories/:id`
...
`POST /api/v1.1.4/products/:product_id/inventories`
...
`PUT|PATCH /api/v1.1.4/products/:product_id/inventories/:id`
...
`DELETE /api/v1.1.4/products/:product_id/inventories/:id`
