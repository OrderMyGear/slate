...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.4/products/22287/options/47204/sub_options?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v1.1.4/products/:product_id/options/:option_id/sub_options`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.4/products/22287/options/47204/sub_options/1234?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v1.1.4/products/:product_id/options/:option_id/sub_options/:id`
...
`POST /api/v1.1.4/products/:product_id/options/:option_id/sub_options`
...
`PUT|PATCH /api/v1.1.4/products/:product_id/options/:option_id/sub_options/:id`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.4/products/22287/options/47204/sub_options/559579?token=GXzAxWkkyYLsESGQTU15" \
  -X DELETE
```
...
`DELETE /api/v1.1.4/products/:product_id/options/:option_id/sub_options/:id`
