...
```shell
 GET https://subdomain.mybrightsites.com/api/v1.1/vendors?token=GXzAxWkkyYLsESGQTU15 
```
...
```shell
 GET https://subdomain.mybrightsites.com/api/v1.1/vendors/579?token=GXzAxWkkyYLsESGQTU15 
```
...
```shell
 POST https://subdomain.mybrightsites.com/api/v1.1/vendors?token=GXzAxWkkyYLsESGQTU15 { "vendor": { "name": "The Willy Wonka Company", "address1": "2010 Oompa-Loompa drive", "city": "Sweetstown", "state": "Texas", "zip_code": "99099", "phone": "123123123123", "email": "test@test.com", "account_number": "account123123" } } 
```
...
```shell
 PUT https://subdomain.mybrightsites.com/api/v1.1/vendors/579?token=GXzAxWkkyYLsESGQTU15 { "vendor": { "name": "The Willy Wonka Great Company", } } 
```
...
```shell
 DELETE https://subdomain.mybrightsites.com/api/v1.1/vendors/579?token=GXzAxWkkyYLsESGQTU15 
```
