...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1/products/22287/options?token=GXzAxWkkyYLsESGQTU15"
```
...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1/products/22287/options/47204?token=GXzAxWkkyYLsESGQTU15"
```
...
`PUT|PATCH /api/v1.1/products/:product_id/options/:id`
