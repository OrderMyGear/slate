...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.1.1/products?token=GXzAxWkkyYLsESGQTU15"
```
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.1.1/products/579?token=GXzAxWkkyYLsESGQTU15"
```
...
`PUT|PATCH /api/v2.1.1/products/:id`
