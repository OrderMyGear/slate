...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.1.1/users/1/moas_email_approvers?token=GXzAxWkkyYLsESGQTU15"
```
...
`PUT|PATCH /api/v2.1.1/users/:user_id/moas_email_approvers/:id`
