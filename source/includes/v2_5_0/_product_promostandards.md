...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.5.0/products/22287/promostandards?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v2.5.0/products/:product_id/promostandards`
...
```shell
curl "https://subdomain.bsites-staging.com/api/v2.5.0/products/22287/promostandards/batch_update?token=GXzAxWkkyYLsESGQTU15" \
  -X PUT \
