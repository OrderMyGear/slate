...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.5.0/vendors?token=GXzAxWkkyYLsESGQTU15"
```
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.5.0/vendors/579?token=GXzAxWkkyYLsESGQTU15"
```
...
`PUT|PATCH /api/v2.5.0/vendors/:id`
