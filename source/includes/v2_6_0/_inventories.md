...
```shell
curl "https://subdomain.bsites-staging.com/api/v2.6.0/inventories?token=GXzAxWkkyYLsESGQTU15"
```
...
```shell
curl "https://subdomain.bsites-staging.com/api/v2.6.0/inventories/44371/batch_update?token=GXzAxWkkyYLsESGQTU15" \
  -X PUT \
...
`PUT /api/v2.6.0/inventories/:product_id/batch_update`
