...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.6.0/categories?token=GXzAxWkkyYLsESGQTU15"
```
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.6.0/categories/579?token=GXzAxWkkyYLsESGQTU15"
```
...
`DELETE /api/v2.6.0/categories/:id`
