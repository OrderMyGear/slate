...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.7/products?token=GXzAxWkkyYLsESGQTU15"
```
...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.7/products/579?token=GXzAxWkkyYLsESGQTU15"
```
...
`PUT|PATCH /api/v1.1.7/products/:id`
