...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.7/orders/2089/line_items/25135/split_items?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v1.1.7/orders/:order_id/line_items/:line_item_id/split_items`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.7/orders/2089/line_items/25135/split_items/108?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v1.1.7/orders/:order_id/line_items/:line_item_id/split_items/:id`
...
`PUT /api/v1.1.7/orders/:order_id/line_items/:line_item_id/split_items/:id`
...
`DELETE /api/v1.1.7/orders/:order_id/line_items/:line_item_id/split_items/:id`
