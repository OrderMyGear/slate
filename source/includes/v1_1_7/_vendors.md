...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.7/vendors?token=GXzAxWkkyYLsESGQTU15"
```
...
```shell
curl "https://subdomain.mybrightsites.com/api/v1.1.7/vendors/579?token=GXzAxWkkyYLsESGQTU15"
```
...
`PUT|PATCH /api/v1.1.7/vendors/:id`
