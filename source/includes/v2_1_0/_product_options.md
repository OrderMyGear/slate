...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.1.0/products/22287/options?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v2.1.0/products/:product_id/options`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.1.0/products/22287/options/47204?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v2.1.0/products/:product_id/options/:id`
...
`POST /api/v2.1.0/products/:product_id/options`
...
`PUT|PATCH /api/v2.1.0/products/:product_id/options/:id`
...
`DELETE /api/v2.1.0/products/:product_id/options/:id`
