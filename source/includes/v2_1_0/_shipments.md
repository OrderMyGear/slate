...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.1.0/orders/1/shipments?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v2.1.0/orders/:order_id/shipments`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.1.0/orders/1/shipments/14?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v2.1.0/orders/:order_id/shipments/:id`
...
`POST /api/v2.1.0/orders/:order_id/shipments`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.1.0/orders/1/shipments/39?token=GXzAxWkkyYLsESGQTU15" \
  -X DELETE
```
...
`DELETE /api/v2.1.0/orders/:order_id/shipments/:id`
