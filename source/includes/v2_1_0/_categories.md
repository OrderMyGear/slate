...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.1.0/categories?token=GXzAxWkkyYLsESGQTU15"
```
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.1.0/categories/579?token=GXzAxWkkyYLsESGQTU15"
```
...
`PUT|PATCH /api/v2.1.0/categories/:id`
...
`DELETE /api/v2.1.0/categories/:id`
