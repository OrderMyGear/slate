...
```shell
 GET https://subdomain.mybrightsites.com/api/v2.1.0/products/1/quantity_discounts?token=GXzAxWkkyYLsESGQTU15
```
...
`GET /api/v2.1.0/products/:product_id/quantity_discounts`
...
```shell
 GET https://subdomain.mybrightsites.com/api/v2.1.0/products/1/quantity_discounts/579?token=GXzAxWkkyYLsESGQTU15
```
...
`GET /api/v2.1.0/products/:product_id/quantity_discounts/:id`
...
```shell
 POST https://subdomain.mybrightsites.com/api/v2.1.0/products/1/quantity_discounts?token=GXzAxWkkyYLsESGQTU15 { "quantity_discount": { "quantity": 10, "modifier": 990.0 } }
```
...
`POST /api/v2.1.0/products/:product_id/quantity_discounts`
...
```shell
 PUT https://subdomain.mybrightsites.com/api/v2.1.0/products/1/quantity_discounts/579?token=GXzAxWkkyYLsESGQTU15 { "quantity_discount": { "modifier": 980.0 } }
```
...
`PUT|PATCH /api/v2.1.0/products/:product_id/quantity_discounts/:id`
...
```shell
 DELETE https://subdomain.mybrightsites.com/api/v2.1.0/products/1/quantity_discounts/579?token=GXzAxWkkyYLsESGQTU15
```
...
`DELETE /api/v2.1.0/products/:product_id/quantity_discounts/:id`
