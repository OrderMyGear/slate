...
<div><strong>user[timezone] </strong></div><div>optional</div> | <div>Timezone</div><div>Must be a String.</div><div><a href="https://en.wikipedia.org/wiki/List_of_tz_database_time_zones">The list of available timezones</a></div>
