...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.1.0/product/:product_id/related_products?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/api/v2.1.0/products/:product_id/related_products`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.1.0/product/1/related_products/579?token=GXzAxWkkyYLsESGQTU15" \
  -X POST
```
...
`POST /api/api/v2.1.0/product/:product_id/related_products/:id`
...
`DELETE /api/api/v2.1.0/product/:product_id/related_products/:id`
