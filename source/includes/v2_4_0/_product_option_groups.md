...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.4.0/products/22287/option_groups?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v2.4.0/products/:product_id/option_groups`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.4.0/products/22287/option_groups/4?token=GXzAxWkkyYLsESGQTU15"
```
...
`GET /api/v2.4.0/products/:product_id/option_groups/:id`
...
`POST /api/v2.4.0/products/:product_id/option_groups`
...
```shell
curl "https://subdomain.mybrightsites.com/api/v2.4.0/products/22287/option_groups/5?token=GXzAxWkkyYLsESGQTU15" \
  -X PUT \
  -H "Content-Type: application/json" \
  -d @- <<'EOF'
{
...
`PUT|PATCH /api/v2.4.0/products/:product_id/option_groups/:id`
...
`DELETE /api/v2.4.0/products/:product_id/option_groups/:id`
